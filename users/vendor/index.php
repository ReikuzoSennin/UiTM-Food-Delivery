    ...
    <div class="admin-content" id="market">
        ...
        <form action="index.php" method="post">
            ...
            <div>
                ...
                <button class="btn btn-big" name="update-shop">Update</button><br><br>
            </div>
        </form> <br>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <button class="btn btn-big" name="upload-image">Upload Image</button>
        </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="index.php" method="post">
                                ...
                                <button name="delete-btn" class="btn btn-big">DELETE</button>
                            </form>
                        </td>
                    </tr>
                    <?php
